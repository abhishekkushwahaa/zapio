...
export default function ZapCreate() {
  ...
  return (
    <div>
      <Appbar />
      <div className="flex justify-end bg-amber-600 p-4">
        <PrimaryButton
          onClick={async () => {
      ...
      <div className="w-full min-h-screen bg-amber-600 flex flex-col justify-center">
...
function Modal({
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-zinc-900 bg-opacity-70 flex">
        ...
        <div className="relative bg-zinc-900 rounded-lg shadow ">
          <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
            ...
            <button
              ...
              type="button"
              className="text-gray-400 bg-transparent hover:bg-amber-600 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                ...
                {availableItems.map(({ id, name, image }) => {
                  return (
                    <div
                      ...
                      className="flex border p-4 cursor-pointer hover:bg-amber-600"
                      key={id}
                    >
